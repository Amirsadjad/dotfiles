...
let s:carbon_Color2 = '#9090cc' " identifier
...
let s:carbon_Color10 = '#182338' " gutter, sign background
...
let s:carbon_Color16 = '#1c2a43' " caret line background
...
let s:carbon_Color25 = '#265371' " cursor line
let s:carbon_Color26 = '#D0D6B5' " true, false
...
call s:highlight('Statement', '', s:carbon_Color0, 'italic')
...
call s:highlight('phpDefine', '', s:carbon_Color0, '')
...
call s:highlight('phpConstant', '', s:carbon_Color4, 'bold')
...
call s:highlight('phpStaticClasses', '', s:carbon_Color4, '')
